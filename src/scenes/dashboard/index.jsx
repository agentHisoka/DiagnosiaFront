...
const HomeDashy = () => {
  ...
  return (
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="relative w-full">
                          <div className="overflow-hidden h-2 text-xs flex rounded bg-blue-200">
                            <div className="w-2/3 shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-600"></div>
                          </div>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr className="text-gray-700 dark:text-gray-100">
                    ...
                    <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                      <div className="flex items-center">
                        ...
                        <div className="relative w-full">
                          <div className="overflow-hidden h-2 text-xs flex rounded bg-blue-200">
                            <div className="w-2/5 shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-500"></div>
                          </div>
                        </div>
                      </div>
                    </td>
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="relative w-full">
                          <div className="overflow-hidden h-2 text-xs flex rounded bg-pink-200">
                            <div className="w-4/12 shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-pink-500"></div>
                          </div>
                        </div>
                      </div>
                    </td>
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="relative w-full">
                          <div className="overflow-hidden h-2 text-xs flex rounded bg-red-200">
                            <div className="w-3/5 shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-red-500"></div>
                          </div>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr className="text-gray-700 dark:text-gray-100">
                    ...
                    <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                      <div className="flex items-center">
                        ...
                        <div className="relative w-full">
                          <div className="overflow-hidden h-2 text-xs flex rounded bg-blue-200">
                            <div className="w-3/12 shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-700"></div>
                          </div>
                        </div>
                      </div>
                    </td>
    ...
    // </Box>
    // <div>
    //     <h1 classNameName="text-3xl font-semibold mb-4 text-center">Welcome to Disease AI</h1>
    //     <p classNameName="text-lg mb-6 text-center">
    //       Helping patients identify diseases based on symptoms using AI.
    //     </p>

    // <div classNameName="min-h-screen flex justify-center items-center">
    //   <div classNameName="bg-slate-600 rounded-lg p-8 shadow-xl max-w-4xl w-full">

    //     <div classNameName="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    //       {/* Medical Article Card */}
    //       <div
    //         classNameName="bg-blue-200 rounded-lg p-6 hover:bg-blue-300 transition duration-300 transform hover:scale-105 cursor-pointer"
    //         onClick={openModal}
    //       >
    //         <h2 classNameName="text-lg font-semibold mb-2">Understanding Common Cold</h2>
    //         <p classNameName="text-gray-600">
    //           Learn about symptoms, causes, and treatments for the common cold.
    //         </p>
    //       </div>

    //       {/* Add more medical article cards here */}
    ...
    // <div
    //   id="article-modal"
    //   classNameName={`fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 ${
    //     isModalOpen ? '' : 'hidden'
    //   }`}
    // >
    //   <div classNameName="bg-white rounded-lg p-8 shadow-xl max-w-3xl w-full">
    //     <h2 classNameName="text-xl font-semibold mb-4">Understanding Common Cold</h2>
    //     <p classNameName="text-gray-600">
    //       The common cold is a viral infection primarily affecting the nose and throat...
    //     </p>
    //     <button classNameName="mt-6 bg-blue-500 text-white py-2 px-4 rounded-lg" onClick={closeModal}>
    //       Close
    //     </button>
    //   </div>
    // </div>
